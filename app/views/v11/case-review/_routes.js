...
router.post('/current/case-selector/ready-for-review', (req, res, next) => {
     // redirect to "case-manager-assign" page.
   res.redirect('/current/case-selector/case-manager-assign')
 })

// route for assigning cases
router.post('/current/case-selector/case-manager-assign', (req, res, next) => {
      ...
      if (req.session.data['assign-caseload'] == "new-caseload") {
        ...
        res.redirect('/current/case-selector/create-new-case-ready-review')
      } else {
        // redirect to "ready-for-review-success" page.
        res.redirect('/current/case-selector/ready-for-review-success')
      }
})

// route for reassigning cases
router.post('/current/case-selector/case-manager-reassign', (req, res, next) => {
       // Checks radio options, if "Add a new caseload" is selected, route to "create-new-case-ready-review" page.
      if (req.session.data['reassign-caseload'] == "new-caseload") {
         // redirect to "create-new-case-ready-review" page.
          res.redirect('/current/case-selector/create-new-case-in-review')
        ...
        console.log(1, req.session.data)
        res.redirect('/current/case-selector/assigned-for-review-success')
      }
})
// route for creating caseload - ready for review
router.post('/current/case-selector/create-new-case-ready-review', (req, res, next) => {
         // redirect to "create-caseload-success" page.
        res.redirect('/current/case-selector/create-caseload-ready-review-success')
      }
)
// route for creating caseload - in review
router.post('/current/case-selector/create-new-case-in-review', (req, res, next) => {
         // redirect to "create-caseload-success" page.
        res.redirect('/current/case-selector/create-caseload-in-review-success')
      }
)
...
// Triage route //
router.post('/current/case-selector/ready-to-make-next-step', function (req, res) {
...
router.post('/current/review/ready-to-make-next-step', function (req, res) {
...
router.post('/current/case-review/ready-to-make-next-step', function (req, res) {
...
router.post('/current/case-review/question-link', (req, res, next) => {
    if (req.session.data['question-for']) {
      ...
      switch (req.session.data['question-for']) {
        case("Unassigned"):
        href = '/current/case-review/unassigned-questions';
        break;
        case("Claimant"):
        href = '/current/case-review/questions-claimant';
        break;
        case("Internal medical support"):
        href = '/current/case-review/questions-internal-medical-support';
        break;
        case("Internal non medical support"):
        href = '/current/case-review/questions-internal-non-medical-support';
        break;
        case("External health professional"):
        href = '/current/case-review/questions-external-medical-health-professional';
        break;
        //this is the hardcoded bit if one of the links fails
        default:
        href = '/current/case-review/summary';
      }
      ...
      res.redirect('/current/case-review/summary')
...
router.post('/current/case-review/question-preparingfood', (req, res, next) => {
    if (req.session.data['question-for']) {
      console.log('is-this-calling-questions', req.session.data)
...
//Start routes for the 'adding a question' journey (collated questions view)
    ...
    router.post('/current/case-review/question-unassigned-add', (req, res, next) => {
        if (req.session.data['question-for-unassigned']) {
          ...
          res.redirect('/current/case-review/unassigned-questions')
          }
        })

//Adding a question to claimant
        router.post('/current/case-review/question-add', (req, res, next) => {
            if (req.session.data['question-for-claimant']) {
              ...
              switch (req.session.data['question-for-claimant']) {
                ...
                //this is the hardcoded bit if one of the links fails
                default:
                href = '/current/case-review/questions';
              }
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              req.session.data.queriesQuestions[req.session.data.queriesQuestions.length - 1].href = href;
              res.redirect('/current/case-review/questions-claimant')
              }
            })
          ...
          // Add a question for internal medical support
            router.post('/current/case-review/question-internal-medical-support-add', (req, res, next) => {
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/questions-internal-medical-support')

                  }
                })

                      // Add a question for internal non medical support
                        router.post('/current/case-review/question-internal-non-medical-add', (req, res, next) => {
                            ...
                            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                              ...
                              res.redirect('/current/case-review/questions-internal-non-medical-support')
                            ...
                            // Add a question for external health professional
                              router.post('/current/case-review/question-external-medical-add', (req, res, next) => {
                                  ...
                                  //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                                    ...
                                    res.redirect('/current/case-review/questions-external-medical-health-professional')
...
router.post('/current/case-review/activities/preparing-food', (req, res, next) => {
    if (req.session.data['who-is-question-for-prepfood']) {
      ...
      switch (req.session.data['who-is-question-for-prepfood']) {
        ...
        //this is the hardcoded bit if one of the links fails
        default:
        href = '/current/case-review/tasklist';
      }
    ...
    //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
      ...
      res.redirect('/current/case-review/activities/preparing-food')
      }
    })


  //Start routes for eating and drinking: questions
    router.post('/current/case-review/activities/taking-nutrition', (req, res, next) => {
        ...
        //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
          ...
          res.redirect('/current/case-review/activities/taking-nutrition')
          }
        })

        //Start routes for managing treatments: questions
          router.post('/current/case-review/activities/managing-treatments', (req, res, next) => {
              ...
              //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                ...
                res.redirect('/current/case-review/activities/managing-treatments')
...
router.post('/current/case-review/activities/washing-and-bathing', (req, res, next) => {
    ...
    //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
      ...
      res.redirect('/current/case-review/activities/washing-and-bathing')
...
//Start routes for managing toilet needs: questions
  router.post('/current/case-review/activities/managing-toilet-needs', (req, res, next) => {
      if (req.session.data['who-is-question-for-toilet']) {
        ...
        switch (req.session.data['who-is-question-for-toilet']) {
          ...
          //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
            ...
            res.redirect('/current/case-review/activities/managing-toilet-needs')

            }
          })

    //Start routes for dressing and undressing: questions
      router.post('/current/case-review/activities/dressing-and-undressing', (req, res, next) => {
            ...
            switch (req.session.data['who-is-question-for-dressing']) {
              ...
              href = '/current/case-review/tasklist';
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/activities/dressing-and-undressing')

                  }
                })

          //Start routes for talking and understanding: questions
            router.post('/current/case-review/activities/communicating-verbally', (req, res, next) => {
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/activities/communicating-verbally')

                  }
                })

          //Start routes for Reading and understanding: questions
            router.post('/current/case-review/activities/reading-and-understanding', (req, res, next) => {
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/activities/reading-and-understanding')

                  }
                })

          //Start routes for Mixing with others: questions
            router.post('/current/case-review/activities/engaging-face-to-face', (req, res, next) => {
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/activities/engaging-face-to-face')

                  }
                })

      //Start routes for managing money: questions
        router.post('/current/case-review/activities/managing-money', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/activities/managing-money')

              }
            })
    //Start routes for planning, following journeys: questions
      router.post('/current/case-review/activities/planning-and-following-journeys', (req, res, next) => {
          ...
          //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
            ...
            res.redirect('/current/case-review/activities/planning-and-following-journeys')
          ...
          //Start routes for moving around: questions
            router.post('/current/case-review/activities/moving-around', (req, res, next) => {
                ...
                //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                  ...
                  res.redirect('/current/case-review/activities/moving-around')
                ...
                //Start routes for additional information: questions
                  router.post('/current/case-review/additional-information', (req, res, next) => {
                      ...
                      //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
                        ...
                        res.redirect('/current/case-review/additional-information')
      ...
      router.post('/current/case-review/condition-one', (req, res, next) => {
          ...
          //  req.session.data.queriesConditionOne[req.session.data.queriesConditionOne.length - 1].content = req.session.data['query-content']
            ...
            res.redirect('/current/case-review/condition-one')

            }
          })

        //Routes for query condtion2
        router.post('/current/case-review/condition-two', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-two')

              }
        })

        //Routes for query condtion3
        router.post('/current/case-review/condition-three', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-three')

              }
        })

        //Routes for query condtion4
        router.post('/current/case-review/condition-four', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-four')

              }
        })

        //Routes for query condtion5
        router.post('/current/case-review/condition-five', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-five')

              }
        })

        //Routes for query condtion6
        router.post('/current/case-review/condition-six', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-six')
        ...
        router.post('/current/case-review/condition-seven', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-seven')
        ...
        router.post('/current/case-review/condition-eight', (req, res, next) => {
            ...
            //  req.session.data.queriesTakeNutrition[req.session.data.queriesTakeNutrition.length - 1].content = req.session.data['query-content']
              ...
              res.redirect('/current/case-review/condition-eight')
...
router.post('/current/case-review/set-descriptor', (req, res, next) => {
  //  if (req.session.data['set-descriptor'] == "Can prepare and cook a simple meal unaided" ) {
    console.log('/current/case-review/set-descriptor', req.session.data)
    const descriptor = req.session.data['set-descriptor']
        ...
        switch (req.session.data['set-descriptor']) {
          ...
          //this is the hardcoded bit if one of the links fails
          default:
          points = '/current/case-review/tasklist';
        }
     ...
     scoresChoice.push({ descriptor, points })
      ...
      res.redirect('/current/case-review/review-activity-descriptors')
    //}
})

router.post('/current/case-review/review-activity-descriptors', (req, res, next) => {
...
router.post('/current/case-review/activities/taking-nutrition', (req, res, next) => {
  console.log('/current/case-review/activities/taking-nutrition', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-taking-nutrition')
})

router.post('/current/case-review/set-action/set-action-taking-nutrition', (req, res, next) => {
  ...
  switch (req.session.data['set-an-action']) {
    case('The claimant'):
    href = '/current/case-review/contact-claimant-action';
    break;
    case("The claimant's doctor"):
    href = '/current/case-review/contact-hcp1-action';
    break;
    case("The claimant's urologist"):
    href = '/current/case-review/contact-hcp2-action';
    break;
    case("The claimant's consultant clinical urologist"):
    href = '/current/case-review/contact-hcp3-action';
    break;
    case('VAL'):
    href = '/current/case-review/contact-val-action';
    break;
    case('Resolve this issue another way'):
    href = '/current/case-review/none-these-action';
    break;
    //this is the hardcoded bit if one of the links fails
    default:
    href = '/current/case-review/tasklist';
...
router.post('/current/case-review/activities/managing-treatments', (req, res, next) => {
  console.log('/current/case-review/activities/managing-treatments', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-managing-treatments')
})

router.post('/current/case-review/set-action/set-action-managing-treatments', (req, res, next) => {
...
router.post('/current/case-review/activities/washing-and-bathing', (req, res, next) => {
  console.log('/current/case-review/activities/washing-and-bathing', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-washing-and-bathing')
})

router.post('/current/case-review/set-action/set-action-washing-and-bathing', (req, res, next) => {
...
router.post('/current/case-review/activities/managing-toilet-needs', (req, res, next) => {
  console.log('/current/case-review/activities/managing-toilet-needs', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-managing-toilet-needs')
})

router.post('/current/case-review/set-action/set-action-managing-toilet-needs', (req, res, next) => {
...
router.post('/current/case-review/activities/dressing-and-undressing', (req, res, next) => {
  console.log('/current/case-review/activities/dressing-and-undressing', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-dressing-and-undressing')
})

router.post('/current/case-review/set-action/set-action-dressing-and-undressing', (req, res, next) => {
...
router.post('/current/case-review/activities/communicating-verbally', (req, res, next) => {
  console.log('/current/case-review/activities/communicating-verbally', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-communicating-verbally')
})

router.post('/current/case-review/set-action/set-action-communicating-verbally', (req, res, next) => {
...
router.post('/current/case-review/activities/reading-and-understanding', (req, res, next) => {
  console.log('/current/case-review/activities/reading-and-understanding', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-reading-and-understanding')
})

router.post('/current/case-review/set-action/set-action-reading-and-understanding', (req, res, next) => {
...
router.post('/current/case-review/activities/engaging-face-to-face', (req, res, next) => {
  console.log('/current/case-review/activities/engaging-face-to-face', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-engage-face-to-face')
})

router.post('/current/case-review/set-action/set-action-engage-face-to-face', (req, res, next) => {
...
router.post('/current/case-review/activities/managing-money', (req, res, next) => {
  console.log('/current/case-review/activities/managing-money', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-managing-money')
})

router.post('/current/case-review/set-action/set-action-managing-money', (req, res, next) => {
...
router.post('/current/case-review/activities/planning-and-following-journeys', (req, res, next) => {
  console.log('/current/case-review/activities/planning-and-following-journeys', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-planning-and-following-journeys')
})

router.post('/current/case-review/set-action/set-action-planning-and-following-journeys', (req, res, next) => {
...
router.post('/current/case-review/activities/moving-around', (req, res, next) => {
  console.log('/current/case-review/activities/moving-around', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/set-action/set-action-moving-around')
})

router.post('/current/case-review/set-action/set-action-moving-around', (req, res, next) => {
...
router.post('/current/case-review/evidence-detail', (req, res, next) => {
    if (req.session.data['evidence-one-note'] == "question-about-this-condition" ) {
      console.log('/current/case-review/evidence-detail', req.session.data)
      ...
      res.redirect('/current/case-review/set-action/set-action-evidence')
        ...
        //Routes for tagged documents linked to Evidence
            ...
            res.redirect('/current/case-review/tagging-evidence/evidence-one')
    ...
    res.redirect('/current/case-review/evidence-detail')

    }
    })

// follow up for tagging important info: evidence one
    router.post('/current/case-review/tagging-evidence/evidence-one', (req, res, next) => {
...
router.post('/current/case-review/set-action/set-action-evidence', (req, res, next) => {
...
router.post('/current/case-review/evidence-detail-two', (req, res, next) => {
    if (req.session.data['evidence-note-two'] == "question-about-this-condition" ) {
      ...
      res.redirect('/current/case-review/set-action/set-action-evidence-two')

    } else if (req.session.data['evidence-note-two'] == "important-to-this-case" ) {
        //Routes for tagged documents linked to Evidence
            console.log('/current/case-review/evidence-detail-two', req.session.data)
            const name = req.session.data['query-content']
            //const pageURL = req.session.data['page-URL'][1]['contact-claimant-page']
            //console.log(pageURL)
            const section = req.session.data.source
            ...
            res.redirect('/current/case-review/tagging-evidence/evidence-two')
    ...
    res.redirect('/current/case-review/evidence-detail-two')

    }
    })

// follow up for tagging important info: evidence two
    router.post('/current/case-review/tagging-evidence/evidence-two', (req, res, next) => {
...
router.post('/current/case-review/set-action/set-action-evidence-two', (req, res, next) => {
  console.log('this is evidence query')
  console.log(req.session.data)
...
router.post('/current/case-review/contact-claimant-action', (req, res, next) => {
  console.log('/current/case-review/contact-claimant-action', req.session.data)
  const name = req.session.data['query-content']
  const section = req.session.data.source
  const queries = req.session.data.queries || []
  queries.push({ name, section })
  req.session.data.queries = queries
  res.redirect('/current/case-review/contact-claimant-action')
})
